...
<body>
    <a href="index.html#section-respuestas">   
        ...
        <table id="table" class="table table-responsive table-hover" data-toggle="table" data-search="true" data-filter-control="true" 
			...
			<th data-field="prenom" data-filter-control="input" data-sortable="true">
            <div class="th-inner sortable both asc">Apellido</div>
                    <div class="filterControl">
                        <input type="text" class="form-control">
                    </div>
            </th>   
			<th data-field="examen" data-filter-control="input" data-sortable="true">
            <div class="th-inner sortable both asc">Cedula</div>
                    <div class="filterControl">
                        <input type="text" class="form-control">
                    </div>
            </th>   
